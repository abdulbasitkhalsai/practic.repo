...
//Q#3
let personName = "Abdul Basit Khalsai";
...
let message = `${famous_Person} said, "Failure is the word unknown to me"`;
console.log(message);
//Q#6
...
//Q#11
let names = ["Muhammad Mumtaz", "Ahmed Raza", "Muhammad Faizan", "Muhammad Salman", "Muhammad Irfan"];
...
//Q#13
let modeOfTransport = ["Honda Civic", "Toyota Yaris", "BRV", "V8"];
for (var index in modeOfTransport) {
    console.log(`I would like to own a ${modeOfTransport[index]}`);
}
//Q#14
let guestName = ["Ali", "Ahmed", "Adnan", "Shakir", "Sabir", "Naveed"];
